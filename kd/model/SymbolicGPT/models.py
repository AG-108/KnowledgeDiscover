...
class PointNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        #for i in range(config.number_of_points):
...
class tNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        #self.input_layer_norm = nn.LayerNorm(config.number_of_points)
...
class GPT(nn.Module):
    ...
    def __init__(self, config, pointNetConfig=None):
        ...
        if self.pointNetConfig is not None:            
            ...
            # self.pointFeatures = (self.pointNetConfig.numberofVars+self.pointNetConfig.numberofYs)*self.pointNetConfig.number_of_points
    ...
    def forward(self, idx, targets=None, points=None, variables=None, tokenizer=None):
        ...
        if targets is not None:
            ...
            #     recPoints = recPoints.view(b*self.pointNetConfig.number_of_points,
            #                     self.pointNetConfig.numberofVars+self.pointNetConfig.numberofYs)
            #     targetPoints = points.view(b*self.pointNetConfig.number_of_points,
            #                     self.pointNetConfig.numberofVars+self.pointNetConfig.numberofYs) 
